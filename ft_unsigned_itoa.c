...
static int	n_count(unsigned int n)
{
	int	cnt;
...
static void	p_input(char *p, unsigned int n, int neg)
{
	int	inc_p;
	int	amount;
...
static void	is_max_neg_int(int neg_max_int, char *p, unsigned int n, int neg)
{
	if (neg_max_int)
	{
